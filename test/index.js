...
describe('cli', () => {
    ...
    describe('CHANGELOG.md does not exist', () => {
        ...
        it('includes all commits if --first-release is true', () => {
            ...
            fs.readFile('./CHANGELOG.md', 'utf-8', (err, content) => {
    ...
    it('handles commit messages longer than 80 characters', () => {
        ...
        fs.readFile('./CHANGELOG.md', 'utf-8', (err, data) => {
            should.not.exist(err);
            should.exist(data);
            data.should.match(/this is my fairly long commit message which is testing whether or not we allow for long commit messages/);
            done();
        });
    });
...
describe('releaseMe', () => {
    ...
    describe('with mocked conventionalRecommendedBump', () => {
        beforeEach(() => {
            ...
            mockery.registerMock('conventional-recommended-bump', (_, cb) => {
    ...
    describe('with mocked conventionalChangelog', () => {
        beforeEach(() => {
            ...
            mockery.registerMock('conventional-changelog', () => {
